...
//  }
  ...
  public static class ReefAlignment
  {
    ...
    public static final double ROT_REEF_ALIGNMENT_P = 0.8;
  
    public static final double ROT_SETPOINT_REEF_ALIGNMENT = -2.967;  // Rotation
    public static final double ROT_TOLERANCE_REEF_ALIGNMENT = 1;
    public static final double X_SETPOINT_REEF_ALIGNMENT = 0.367;  // Vertical pose
    public static final double X_TOLERANCE_REEF_ALIGNMENT = 0.02;
    public static final double Y_SETPOINT_REEF_ALIGNMENT = -0.171;  // Horizontal pose
    public static final double Y_TOLERANCE_REEF_ALIGNMENT = 0.02;
  
    public static final double DONT_SEE_TAG_WAIT_TIME = 1;
    public static final double POSE_VALIDATION_TIME = 6;
